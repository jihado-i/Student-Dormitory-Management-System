<?php
    ...
    if(isset($_POST['update'])){
        ...
        $stmt->execute();
        echo"<script>alert('E-posta başarıyla güncellendi');</script>";
    }
                ...
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Profil</h4>
                        <div class="d-flex align-items-center">
                            <h6 class="card-subtitle"><code>Kullanıcı adı ve kayıt tarihinde değişiklik yapamazsınız!</code> </h6> 
                        </div>
                    </div>
                ...
                <form method="POST">
                    ...
                    $aid=$_SESSION['id'];
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Kayıt tarihi>/h4>
                                        <div class="form-group">
                        ...
                        <div class="form-actions">
                            <div class="text-center">
                                <button type="submit" name="update" class="btn btn-success">Güncelleme</button>
