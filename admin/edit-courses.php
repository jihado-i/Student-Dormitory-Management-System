<?php
    ...
    $stmt->execute();
    echo"<script>alert('Güncelleme başarıyla tamamlandı');
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Çalışma aşamasını değiştirin</h4>
                ...
                <form method="POST">
                    ...
                    <?php	
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"> Okul aşaması</h4>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"> Çalışma aşamasının süresi</h4>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"> Üniversite adı</h4>
                                        <div class="form-group">
                        ...
                        <div class="form-actions">
                            <div class="">
                                <button type="submit" name="submit" class="btn btn-success">Güncelleme</button>
