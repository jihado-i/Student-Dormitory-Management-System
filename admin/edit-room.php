        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Oda ayrıntılarını değiştir</h4>
                     ...
                     //$cnt=1;
                       while($row=$res->fetch_object())
                      {
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"> Odadaki kişi sayacı</h4>
                                        <div class="form-group mb-4">
                                            <select class="custom-select mr-sm-2" id="seater" name="seater" required="required">
                                                ...
                                                <option value="2">iki kişi</option>
