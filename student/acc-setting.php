        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Şifreyi değiştir</h4>
                </div>
                ...
                $stmt -> fetch(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-subtitle">Son güncelleme: <code><?php echo $result; ?></code> </h6>
                                </div>
                            </div>
                        </div>
                </div>
                ...
                <form method="POST" name="changepwd" id="change-pwd" onSubmit="return valid();">
                    <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">geçerli şifre</h4>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"> Yeni şifre</h4>
                                            <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"> Yeni şifreyi onaylayın<h4>
                                            <div class="form-group">
                    ...
                    <div class="form-actions">
                                <div class="text-center">
                                    <button type="submit" name="changepwd" class="btn btn-success">Güncelleme</button>
                                    <button type="reset" class="btn btn-dark">Iptal</button>
                                    </div>
                            </div>
