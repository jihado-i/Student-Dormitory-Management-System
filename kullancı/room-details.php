        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Rezervasyon yaptığınız odayla ilgili ayrıntılar</h4>
                </div>
                      ...
                      <div class="table-responsive">
                                    <table id="zctb" class="table table-striped table-bordered no-wrap">
                                        ...
                                        while($row=$res->fetch_object())
                                            ...
                                            <td><b> Süre İkamet:</b></td>
                                            <td><?php echo $dr=$row->duration;?> ay</td>

                                            <td><b> yemek durumu:</b></td>
                                            <td>
                                            ...
                                            <td>IQD<?php echo $fpm=$row->feespm;?></td>
                                            ...
                                            <td><b> Çalışma aşaması:</b></td>
                                            <td><?php echo $row->course;?></td>
                                            </tr>


                                            <tr>
                                            <td><b> Acil durum irtibat numarası:</b></td>
                                            <td><?php echo $row->egycontactno;?></td>
                                            <td><b>Velinin adı:</b></td>
                                            <td><?php echo $row->guardianName;?></td>
                                            <td><b>Ebeveyn ilişkisi:</b></td>
                                            <td><?php echo $row->guardianRelation;?></td>
                                            </tr>

                                            <tr>
                                            <td><b> Ebeveynin telefon numarası:</b></td>
                                            <td colspan="6"><?php echo $row->guardianContactno;?></td>
                                            </tr>

                                            <tr>
                                            <td><b>geçerli adres:</b></td>
                                            <td colspan="2">
